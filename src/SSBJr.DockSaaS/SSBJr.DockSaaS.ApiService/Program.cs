...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Contact = new OpenApiContact
        {
            ...
            Url = new Uri("https://github.com/SamuelSBJr97/SSBJr.DockSaaS")
        },
...
await using (var scope = app.Services.CreateAsyncScope())
{
    ...
    for (int attempt = 1; attempt <= retryCount; attempt++)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                Log.Error("PostgreSQL connection failed. If using Aspire, ensure it's running with: dotnet run --project SSBJr.DockSaaS.AppHost");
