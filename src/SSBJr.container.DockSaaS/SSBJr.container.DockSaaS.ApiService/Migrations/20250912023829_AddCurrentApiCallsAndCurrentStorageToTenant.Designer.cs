...
namespace SSBJr.container.DockSaaS.ApiService.Migrations
{
    ...
    [Migration("20250912023829_AddCurrentApiCallsAndCurrentStorageToTenant")]
    partial class AddCurrentApiCallsAndCurrentStorageToTenant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.BillingAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.ServiceBackup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.ServiceEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.ServiceTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.TenantInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.TenantSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.UsageRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.AuditLog", b =>
                {
                    ...
                    b.HasOne("SSBJr.container.DockSaaS.ApiService.Models.Tenant", null)
                        .WithMany("AuditLogs")
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.ServiceInstance", b =>
                {
                    ...
                    b.HasOne("SSBJr.container.DockSaaS.ApiService.Models.ServiceDefinition", null)
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.ServiceMetric", b =>
                {
                    ...
                    b.HasOne("SSBJr.container.DockSaaS.ApiService.Models.ServiceInstance", null)
                        .WithMany("Metrics")
            ...
            modelBuilder.Entity("SSBJr.container.DockSaaS.ApiService.Models.TenantInvitation", b =>
                {
                    b.HasOne("SSBJr.container.DockSaaS.ApiService.Models.User", "InvitedByUser")
                        .WithMany()
